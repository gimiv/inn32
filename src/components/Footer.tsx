            ...
            <div className="container mx-auto px-4 md:px-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="mb-6 md:mb-0">
                        <Logo className="h-16 w-auto mb-4" variant="color" />
                    ...
                    <div>
                        ...
                        <div className="flex flex-col space-y-2 text-gray-400">
                            ...
                            <a href="#things-to-do" className="hover:text-white transition-colors">Things To Do</a>
                            <a href="https://inn32.com/booking" className="hover:text-white transition-colors">Book Now</a>
                        </div>
                    </div>
                </div>
